...
- [Lab 10: SPI and DMA](#lab-10-spi-and-dma)
  ...
  - [3. Background](#3-background)
    - [3.1 Serial Peripheral Interface (SPI)](#31-serial-peripheral-interface-spi)
    - [3.2 Shift Registers and 7-Segment Display](#32-shift-registers-and-7-segment-display)
    - [3.3 OLED Hardware Configuration](#33-oled-hardware-configuration)
    - [3.4 SPI Protocol for OLED LCD Display](#34-spi-protocol-for-oled-lcd-display)
  - [(100 points) 4. Experiment](#100-points-4-experiment)
    - [(25 points) 4.1 Driving an SPI interface by "bit-banging"](#25-points-41-driving-an-spi-interface-by-bit-banging)
      - [(10 points) 4.1.1 `setup_bb()`](#10-points-411-setup_bb)
      - [4.1.2 `small_delay()`](#412-small_delay)
      - [(7 points) 4.1.3 `bb_write_bit()`](#7-points-413-bb_write_bit)
      - [(8 points) 4.1.4 `bb_write_halfword()`](#8-points-414-bb_write_halfword)
      - [4.1.5 Debug Bit Banging](#415-debug-bit-banging)
      - [4.1.6 Demonstrate Bit Banging](#416-demonstrate-bit-banging)
    - [(25 points) 4.2 Using the hardware SPI channel](#25-points-42-using-the-hardware-spi-channel)
      - [(10 points) 4.2.1 `init_tim15()` and TIM157 ISR](#10-points-421-init_tim15-and-tim157-isr)
      - [(15 points) 4.2.2 `init_spi2()`](#15-points-422-init_spi2)
      - [4.2.3 Demonstrate SPI2 and 7-Segment Display](#423-demonstrate-spi2-and-7-segment-display)
    - [(15 points) 4.3 Trigger DMA with SPI_TX](#15-points-43-trigger-dma-with-spi_tx)
      - [4.3.1 Demonstrate Trigger DMA with SPI_TX](#431-demonstrate-trigger-dma-with-spi_tx)
    - [(10 points) 4.4 Using SPI to drive the OLED LCD](#10-points-44-using-spi-to-drive-the-oled-lcd)
      - [(10 points) 4.4.1 `init_spi1()`](#10-points-441-init_spi1)
      - [4.4.2 `spi_cmd()`](#442-spi_cmd)
      - [4.4.3 `spi_data()`](#443-spi_data)
      - [4.4.4 `spi1_init_oled()`](#444-spi1_init_oled)
      - [4.4.5 `spi1_display1()`](#445-spi1_display1)
      - [4.4.6 `spi1_display2()`](#446-spi1_display2)
      - [4.4.7 Demonstrate the SPI OLED Display](#447-demonstrate-the-spi-oled-display)
    - [(25 points) 4.5 Trigger SPI1 DMA](#25-points-45-trigger-spi1-dma)
      - [(10 points) 4.5.1 `spi1_setup_dma()`](#10-points-451-spi1_setup_dma)
